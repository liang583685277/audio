/*DHTML PNG暴风雪!oo风格Jascript-based雪效果
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    版本1.3.20081215（以前的转速：v1.2.20041121 a）
    依赖关系：gif/png图像（0到4.gif/png）
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    描述:
    在默认情况下（）在默认情况下初始化（通过addEventHandler（）在底部调用）。
    属性:
    usePNG
    - - - - - - - - - - - - - - - - - -
        支持PNG图像如果支持（“false”返回到GIF）
    flakeTypes
- - - - - - - - - - - - - - - - - -
    设置要使用的片状图像的范围（例如。值为5
    将使用从0开始的图像。png 4. png)。
    flakesMax
- - - - - - - - - - - - - - - - - -
    设置可以存在的雪花的最大数量
    在任何给定的时间屏幕上。
